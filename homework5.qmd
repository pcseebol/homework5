...
In the one-way table, we see there are 36 students whose mothers have higher education.

In the two-way table, we see there are no students for whom both their mother and father had No Education.

In the three-way table, we see that among students who have a father in teaching, 8 students have both parents with higher education.
...
Second, the impact of absences on the data is unclear. The data shows that at least one student appears to have achieved a G3 math score of zero, and after consulting the online source, there are no missing data points for this Final Grade. This means that some students got a 0 final grade, with 0 absences, which seems strange!
...
Again, very hard to see trends from this alone. It is interesting to see that the largest group of students is in parents who both have higher education. Overall, these will be handy graphs to have if we were interesting in identifying interesting trends in this data set in the future!
